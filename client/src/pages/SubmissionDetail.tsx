        ...
        <div className="container max-w-5xl py-3 sm:py-4">
          <div className="flex items-center justify-between gap-2">
            ...
            <div className="flex items-center gap-1.5 flex-shrink-0">
              ...
              <Link href={`/admin/submission/${id}/welcome-pack`}>
                <Button variant="outline" size="sm" className="gap-1.5 border-white/30 text-white hover:bg-white/10 bg-transparent text-xs px-2 sm:px-3" style={{ background: "rgba(201,168,76,0.15)", borderColor: "rgba(201,168,76,0.5)" }}>
                  <Eye className="w-3.5 h-3.5 sm:w-4 sm:h-4" style={{ color: "#C9A84C" }} />
                  <span className="hidden sm:inline" style={{ color: "#C9A84C" }}>Welcome Pack</span>
                  <span className="sm:hidden" style={{ color: "#C9A84C" }}>Pack</span>
                </Button>
              </Link>
